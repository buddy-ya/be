...
public class FeedLikeItemReader implements ItemReader<FeedLikeJobDTO> {
    ...
    public FeedLikeItemReader(JdbcTemplate jdbcTemplate, int totalCount) {
        this.jdbcTemplate = jdbcTemplate;
        this.totalCount = totalCount;
    }

    @Override
    public FeedLikeJobDTO read() {
        if (minFeedId == null) {
