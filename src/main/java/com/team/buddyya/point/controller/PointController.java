...
public class PointController {
    ...
    @PostMapping
    public ResponseEntity<PointRewardResponse> rewardAttendancePoint(@AuthenticationPrincipal CustomUserDetails userDetails){
        PointRewardResponse response = pointService.checkAttendanceAndReward(userDetails.getStudentInfo());
        return ResponseEntity.ok(response);
    }
}
